...
public class commands {
    ...
    public static void registerCommands(CommandDispatcher<ServerCommandSource> dispatcher, boolean dedicated) {
        dispatcher.register(CommandManager.literal("randomizeKeybinds").executes(context -> {
            ...
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.forwardKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.leftKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.backKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.rightKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.jumpKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.sneakKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.sprintKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.inventoryKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.swapHandsKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.dropKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.useKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.attackKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.pickItemKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.chatKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.playerListKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.commandKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.socialInteractionsKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.screenshotKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.togglePerspectiveKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.smoothCameraKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.fullscreenKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.spectatorOutlinesKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.advancementsKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.hotbarKeys[0], ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.hotbarKeys[1], ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.hotbarKeys[2], ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.hotbarKeys[3], ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.hotbarKeys[4], ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.hotbarKeys[5], ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.hotbarKeys[6], ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.hotbarKeys[7], ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.hotbarKeys[8], ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.saveToolbarActivatorKey, ramdomkeybinding(commandsObject));
            MinecraftClient.getInstance().options.setKeyCode(MinecraftClient.getInstance().options.loadToolbarActivatorKey, ramdomkeybinding(commandsObject));
